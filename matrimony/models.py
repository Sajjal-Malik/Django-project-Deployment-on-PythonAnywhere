...
class Hobby(models.Model):
    ...
    class Meta:
        # Verbose name and plural name for better readability in the admin
        verbose_name = "Hobby"
...
class Profile(models.Model):
    ...
    father = models.OneToOneField(FatherProfile, on_delete=models.CASCADE, related_name='dependent', null=True)  # ONEToOne specific for this app
